                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <p class="mb-4 fs-sm fw-bold">
                                                        <a class="text-body" href="javascipt:void(0)">
                                                            {{ $orderItem->name }} x {{ $orderItem->qty }} </a>
                                                        <br>
                                                        <span class="text-muted">${{ number_format($orderItem->total, 2) }}
                                                        </span>
                    ...
                    <div class="card card-lg mb-5 mt-3">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li class="list-group-item d-flex">
                                    <span>Discount {{ !empty($order->coupen_code) ? '(' . $order->coupen_code . ')' : '' }}
                                    </span>
