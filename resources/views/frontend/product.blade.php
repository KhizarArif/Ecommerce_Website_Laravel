            ...
            <div class="col-md-12">
                <div id="related-products" class="carousel">
                    ...
                    @foreach ($relatedProducts as $relatedProduct)
                        @foreach ($relatedProduct->productImages as $relatedProductImage)
                            @if ($relatedProduct->status == 1) <!-- Check if the related product is active -->
                                <div class="card product-card">
                                    <div class="product-image position-relative">
                                        <a href="" class="product-img">
                                            <img class="card-img-top"
                                                src="{{ asset('uploads/product/large/' . $relatedProductImage->image) }}"
                                                alt="">
                                        </a>
                                        <a onclick="addToWishList('{{ $relatedProduct->id }}')" class="whishlist"
