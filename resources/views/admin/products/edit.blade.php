                ...
                const dropzone = $("#image").dropzone({
                    ...
                    success: function(file, response) {
                        ...
                        var fileType = file.type.split('/')[
                            0]; // Get the file type (image, video, pdf)
                        var product = '';
                        ...
                        if (fileType === 'image') {
                            ...
                            // You can display a thumbnail of the video or any other custom UI
                            product = `<div>Video uploaded successfully</div>`;
                        } else if (fileType === 'application') {
                            // If uploaded file is a PDF
                            product = `<div>PDF uploaded successfully</div>`;
                        }
