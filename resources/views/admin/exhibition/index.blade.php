    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('exhibitions.create') }}" class="btn btn-primary">New Exhibition</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-title">
                    <form action="">
                        <button type="button" class="btn btn-danger"> <a href="{{ route('exhibitions.index')}}"
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('exhibitions.edit', $exhibition->id) }}">
                                ...
                                <a href="#" class="btn btn-light btn-sm" onclick="deleteItem('{{$exhibition->id}}')">
...
@section('customJs')
<script>
    function deleteItem(exhibitionId) {
        var url = "{{ route('exhibitions.delete', 'ID') }}";
        var newUrl = url.replace('ID', exhibitionId);
        Swal.fire({
