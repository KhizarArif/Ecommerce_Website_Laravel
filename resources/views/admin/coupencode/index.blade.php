                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                               {{  (!empty($discountCoupen->starts_at)) ? \Carbon\Carbon::parse($discountCoupen->starts_at)->format('Y/m/d H:i:s'): '' }}
                            </td>
                            <td>
                               {{  (!empty($discountCoupen->expires_at)) ? \Carbon\Carbon::parse($discountCoupen->expires_at)->format('Y/m/d H:i:s'): '' }}
                            </td>
                            <td>
